package com.diva.taskkakvero.activity
...
import com.diva.taskkakvero.R
import com.diva.taskkakvero.adapter.SurahAdapter
import com.diva.taskkakvero.fragment.FragmentJadwalSholat.Companion.newInstance
import com.diva.taskkakvero.model.ModelSurah
import com.diva.taskkakvero.networking.Api
import com.diva.taskkakvero.utils.GetAddressIntentService
...
class activity_list_surat : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_list_surah)
    }
